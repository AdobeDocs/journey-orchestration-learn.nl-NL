...
+ [Streaming-gebeurtenissen configureren](/help/configuring-journey-orchestration/configure-streaming-events.md)
...
+ [Handelingen configureren](/help/configuring-journey-orchestration/configure-actions.md)
+ [Een reis maken](/help/create-a-journey.md)
+ [Een reis valideren en publiceren](/help/validate-and-publish-a-journey.md)
+ [Een reis analyseren met behulp van rapportagetools](/help/analyze-a-journey-via-reporting-tools.md)
+ [Dagboekevenementen aan Adobe Experience Platform melden](/help/reporting-step-events-to-adobe-experience-platform.md)
+ [Hoe u hulp kunt zoeken met Journey Orchestration](/help/how-to-find-help-with-journey-orchestration.md)
